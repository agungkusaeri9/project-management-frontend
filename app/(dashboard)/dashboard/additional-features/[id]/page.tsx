...
import {
  ArrowLeft, Trash2, Zap, Calendar, Loader2, FolderOpen, Box, GitBranch, Layers, User, Hash, Clock, CheckCircle2, Circle, AlertTriangle, Edit2
} from 'lucide-react';
  ...
  const handleDelete = () => {
    deleteFeature(id, {
      onSuccess: () => {
        ...
        router.push(`/dashboard/projects/${feature.project_id}`);
      },
      onError: (err: any) => {
    ...
    <div className="w-full space-y-8 pb-12">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            href={`/dashboard/additional-features/${id}/edit`}
            className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold transition-colors flex items-center gap-2 shadow-2xs"
          >
