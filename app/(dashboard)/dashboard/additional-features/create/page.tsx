...
import { useCreateGlobalAdditionalFeature } from '@/features/additional-feature/hooks/use-additional-features';
...
export default function CreateGlobalAdditionalFeaturePage() {
  const router = useRouter();

  const { data: projects, isLoading: isLoadingProjects } = useProjects();
  const { mutate: createFeature, isPending } = useCreateGlobalAdditionalFeature();
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              Define a project assignment and add multiple feature items.
            </p>
          </div>
        </div>
      </div>
