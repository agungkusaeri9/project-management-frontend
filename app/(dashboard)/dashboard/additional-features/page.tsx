...
import {
  Plus, Search, Edit2, Trash2, Loader2, Calendar, FileText, CheckCircle2, Circle, Clock, ChevronLeft, ChevronRight, AlertTriangle, Eye, Zap
} from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Link
          href="/dashboard/additional-features/create"
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-xl transition-colors disabled:opacity-50 border border-slate-200 dark:border-slate-800"
                          title="Delete"
                        >
                          {isDeleting && featureToDelete === feature.id ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Trash2 className="w-3.5 h-3.5" />}
                        </button>
                      </div>
                    </td>
                  </tr>
