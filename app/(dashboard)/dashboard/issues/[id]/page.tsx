                    ...
                    >
                      <div className="flex items-center justify-between border-b border-slate-200/50 dark:border-slate-700/50 pb-2 mb-2">
                        ...
                        <select
                          ...
                          className={`text-xs font-semibold px-2 py-1 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 ${item.status === 'resolved' || item.status === 'closed' ? 'text-emerald-600 dark:text-emerald-400' :
